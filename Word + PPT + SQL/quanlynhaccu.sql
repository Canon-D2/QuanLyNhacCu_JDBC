...
ALTER TABLE `orderdetail`
 ...
 ALTER TABLE `quanlynhaccu`.`product` 
ADD COLUMN `tinhTrang` INT NOT NULL DEFAULT 1 AFTER `image4`;


ALTER TABLE `quanlynhaccu`.`product` 
CHANGE COLUMN `image` `image` VARCHAR(500) NULL DEFAULT 'https://developers.google.com/static/maps/documentation/streetview/images/error-image-generic.png' ;

ALTER TABLE `quanlynhaccu`.`account` 
ADD COLUMN `tinhTrang` INT NOT NULL DEFAULT 1 AFTER `email`;
