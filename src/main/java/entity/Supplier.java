...
public class Supplier {
    ...
    public String toString() {
        return "Supplier{" + "idSupplier=" + idSupplier + ", nameSupplier=" + nameSupplier + ", phoneSupplier=" + phoneSupplier + ", emailSupplier=" + emailSupplier + ", addressSupplier=" + addressSupplier + ", cateID=" + cateID + '}';
    }
}