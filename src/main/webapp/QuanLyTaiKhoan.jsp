                                        ...
                                        <c:forEach items="${listA}" var="o">
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="deleteAccount?id=${o.id}"><button type="button" class="btn btn-danger">Khoá tài khoản</button></a>
                                                    </c:if>
                                                    <c:if test = "${o.tinhTrang != 1}">
                                                        <a href="deleteAccount?id=${o.id}&undelete=true"><button type="button" class="btn btn-warning">Khôi phục</button></a>
                                                    </c:if>
                                                    </td>
                                            </tr>
                                        </c:forEach>
